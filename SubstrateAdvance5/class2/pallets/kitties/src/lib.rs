...
pub mod pallet{
    ...
    pub trait Config: frame_system::Config {
        ...
        type KittyIndex: AtLeast32BitUnsigned + Bounded + Parameter + Copy + Default + MaxEncodedLen;
    ...
    impl<T: Config> Pallet<T>{
        ...
        pub fn create(origin: OriginFor<T>) -> DispatchResult{
            ...
            OwnerAllKitties::<T>::mutate(&who, |kitties_vec|{(kitties_vec).try_push(kitty.clone())}).map_err(|_| Error::<T>::NotEnoughStorage)?;
        ...
        pub fn breed(origin: OriginFor<T>, kitty_id_1: T::KittyIndex, kitty_id_2: T::KittyIndex) -> DispatchResult{
            ...
            KittyOwner::<T>::insert(kitty_id, &who);
            NextKittyId::<T>::set(kitty_id + One::one());
            OwnerAllKitties::<T>::mutate(&who, |kitties_vec|{(kitties_vec).try_push(new_kitty.clone())}).map_err(|_| Error::<T>::NotEnoughStorage)?; 
